...
import com.acmerobotics.roadrunner.ftc.OmniKinematics;
...
import org.firstinspires.ftc.teamcode.adaptations.roadrunner.messages.PoseMessage;
...
public final class OmniDrive {
    public static class Params {
        ...
        public double minProfileAccel = -24;
        public double maxProfileAccel = 40;

        // turn profile parameters (in radians)
        public double maxAngVel = Math.PI * 0.5; // shared with path
        public double maxAngAccel = Math.PI * 0.5;
    ...
    public final OmniKinematics kinematics = new OmniKinematics(
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(OmniDrive.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(OmniDrive.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(OmniDrive.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(OmniDrive.this.rightFront));
        ...
        public Twist2dDual<Time> update() {
            ...
            Twist2dDual<Time> twist = kinematics.forward(new OmniKinematics.WheelIncrements<>(
    ...
    public OmniDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        localizer = new TwoDeadWheelLocalizer(PARAMS.inPerTick);
    ...
    public void setDrivePowers(PoseVelocity2d powers) {
        OmniKinematics.WheelVelocities<Time> wheelVels = new OmniKinematics(1).inverse(
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            OmniKinematics.WheelVelocities<Time> wheelVels = kinematics.inverse(command);

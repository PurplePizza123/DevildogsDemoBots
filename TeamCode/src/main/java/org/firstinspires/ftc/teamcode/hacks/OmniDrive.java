...
public class OmniDrive extends RobotDrive {
     ...
     */
    public OmniDrive(Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight){
     ...
     * @param backRight  the back right motor
     */
    public OmniDrive(boolean autoInvert, Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
    ...
    public void driveWithMotorPowers(double frontLeftSpeed, double frontRightSpeed,
        ...
        motors[MotorType.kFrontLeft.value]
                .set(frontLeftSpeed * rightSideMultiplier * maxOutput);
